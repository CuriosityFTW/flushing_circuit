...
const int pin7 = 7; // expiration valve, expiratory pressure sensor flushing, expiratory flow sensor flushing
...
/*  
          ...
          Serial.print("dP = "); Serial.print(dP); Serial.println(" Pa");
*/  
...
*/  
          t_current = millis() - t_current; //Time taken to execute the current while loop
          t_elapsed += t_current; //Time elapsed in the expiratory phase
        }
        /*
        //SDP sensor
        Wire.requestFrom(0x25, 5); //Contents of first two bytes
...
*/          
          t_current = millis() - t_current; //Time taken to execute the current while loop
          t_elapsed += t_current; //Time elapsed in the hold phase
        }
        /*
        //SDP sensor
        Wire.requestFrom(0x25, 5); //Contents of first two bytes
